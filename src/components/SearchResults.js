		...
		return (
            <div id="info" className={this.props.class}>
              <div className="entered-city col-md-3">
                  <p className="current-city">Weather in <span id="city-name">{this.props.name} {this.props.country}</span></p>
                  <p className="temperature"><span id="icon"></span><span id="temp">{this.props.temp}</span></p>
              </div>
